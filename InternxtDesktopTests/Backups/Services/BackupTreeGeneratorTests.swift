...
final class BackupTreeGeneratorTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        sut = BackupTreeGenerator(root: tmpDirectoryURL, backupUploadService: BackupUploadService(networkFacade: NetworkFacade(mnemonic: "", networkAPI: networkAPI), encryptedContentDirectory: URL(string: "https://drive.internxt.com/app")!, deviceId: 0, bucketId: "", authToken: "", newAuthToken: "", backupClient: MockBackupClient()), progress: Progress())
    }
