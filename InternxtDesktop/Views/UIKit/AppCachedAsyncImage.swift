...
//  InternxtDesktop
//
//  Grabbed from https://github.com/lorenzofiamingo/swiftui-cached-async-image/tree/main/Sources/CachedAsyncImage
//
...
///
///     AppCachedAsyncImage(url: URL(string: "https://example.com/icon.png"))
...
///
///     AppCachedAsyncImage(url: URL(string: "https://example.com/icon.png")) { image in
///         image.resizable()
///     } placeholder: {
///         ProgressView()
///     }
...
/// ``Image/resizable(capInsets:resizingMode:)``, directly to a `AppCachedAsyncImage`.
...
///
///     AppCachedAsyncImage(url: URL(string: "https://example.com/icon.png")) { phase in
...
public struct AppCachedAsyncImage<Content>: View where Content: View {
...
@available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *)
private extension AppCachedAsyncImage {
